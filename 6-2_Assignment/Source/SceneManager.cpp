...
void SceneManager::DefineObjectMaterials()
{
	...
	goldMaterial.shininess = 0;
	goldMaterial.tag = "blue";
...
void SceneManager::SetupSceneLights()
{
	...
	m_pShaderManager->setVec3Value("lightSources[0].ambientColor", 0.1f, 0.75f, 1.01f);
	m_pShaderManager->setVec3Value("lightSources[0].diffuseColor", 0.5f, 1.5f, 0.5f);
	m_pShaderManager->setVec3Value("lightSources[0].specularColor", 0.2f, 1.2f, 0.2f);
